...
namespace Video_Clip2.Clips.Models
{
    ...
    public class SubtitleClip : TextClip, IClip
    {
        ...
        public SubtitleClip(IList<Subtitle> subtitles, bool isMuted, TimeSpan position, TimeSpan delay, TimeSpan duration, int index, double trackHeight, double trackScale)
        ...
        {
            return new SubtitleClip(this.Subtitles, isMuted, position, this.Delay, nextDuration, base.Index, trackHeight, trackScale);
        }
